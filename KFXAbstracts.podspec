#
# Be sure to run `pod lib lint KFXAbstracts.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'KFXAbstracts'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KFXAbstracts.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ChristianFox/KFXAbstracts'
